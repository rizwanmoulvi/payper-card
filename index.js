...
app.get('/skill', (req, res) => res.sendFile(path_1.default.join(__dirname, 'public', 'skill.html')));
...
app.post('/issue-card', express_1.default.json(), async (req, res) => {
    ...
    try {
        ...
        const isSimulationFailure = !verifyResult.isValid &&
...
app.post('/api/demo/run-agent', async (req, res) => {
    try {
        ...
        const transferHash = await transferWalletClient.writeContract({
            ...
            args: [MERCHANT_CRYPTO_WALLET, baseUnits],
        });
